import { createDomainAliveChecker, createRegisterableDomainAliveChecker } from '@/index';

const domain = '6ldu6qa.com';
...
(async () => {
  ...
  console.log(await isRegisterableDomainAlive(domain));
  console.log({ registerableDomainResultCache });
  console.log(await isDomainAlive(domain));
  console.log({ registerableDomainResultCache, resultCache });
})();
